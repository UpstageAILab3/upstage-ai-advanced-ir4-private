...
mappings = {
    "properties": {
        "content": {"type": "text", "analyzer": "nori", "similarity": "lm_dirichlet"},
        "embeddings": {
            "type": "dense_vector",
            "dims": 1024, #768
            "index": True,
...
eval_rag("../data/test2.jsonl", "test_66.csv")
...
# Score :  26.360878 5.4880323 0.72366095 0.43281195

# test Mapping score 0.7777777777777778