...
# Max score 비교하자
    ...
    if result.choices[0].message.tool_calls:
        ...
        sparse_result = sparse_retrieve(standalone_query, 5)
...
eval_rag("../data/test2.jsonl", "test_83.csv")
...
# Score :  26.838966 4.892743 0.72366095 0.43281195
# test Mapping score 0.7933333333333334