...
## Instruction
- 사용자가 대화를 통해 생물학, 물리학, 지구과학, 화학, 의학, 공학, 컴퓨터, 프로그래밍, 코드, 농학, 산업공학, 전자공학, 수학, 통계학, 과학자 등 과학 지식에 관한 주제로 질문하면 search api를 호출할 수 있어야 한다.
...
eval_rag("../data/eval.jsonl", f"submission_{datetime.now().strftime('%Y-%m-%d_%H')}.csv")
