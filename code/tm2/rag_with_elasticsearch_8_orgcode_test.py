...
## Instruction
- 사용자가 과학 지식에 관한 주제로 질문하면 반드시 search 함수를 호출해야 한다.
- 나머지 대화 메시지에는 함수 호출 없이 적절한 대답을 생성한다.
"""
...
eval_rag("../data/test.jsonl", "test_01.csv")
...
gt = {
	...
	3:[],
	4:["910107a6-2a42-41a2-b337-fbf22d6440fe"],
...
# test Mapping score 0.9666666666666667